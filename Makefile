...
prefix=/home/maximilian/openssh
exec_prefix=${prefix}
...
mansubdir=man
sysconfdir=/home/maximilian/openssh
piddir=/var/run
srcdir=.
top_srcdir=.
...
CPPFLAGS=-g -I. -I$(srcdir)  -D_XOPEN_SOURCE=600 -D_BSD_SOURCE -D_DEFAULT_SOURCE $(PATHS) -DHAVE_CONFIG_H
...
PATHSUBS	= \
	...
	-e 's|/usr/bin:/bin:/usr/sbin:/sbin|/usr/bin:/bin:/usr/sbin:/sbin:/home/maximilian/openssh/bin|g'
